...
export function FloatingChat() {
    ...
    const handleSend = async () => {
        ...
        try {
            ...
            // n8n usually returns an array of objects or a single object
            // We look for the 'output' field as mentioned by the user
            let botResponse = "";
            ...
            >
                <div className="bg-primary/10 p-4 border-b border-white/5 flex justify-between items-center">
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-semibold text-sm">Soporte danIAutoma</span>
                    </div>
                ...
                <div className="p-3 border-t border-white/5 bg-slate-900 flex gap-2">
                    <input
                        ...
                        className="flex-1 bg-black/20 text-sm rounded-md px-3 py-2 focus:outline-none focus:ring-1 focus:ring-primary/50"
                    />
